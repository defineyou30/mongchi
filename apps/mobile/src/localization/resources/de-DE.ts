...
export const deDE = {
  ...
  welcome: {
    ...
    slides: {
      first: {
        step: "Schritt 1",
        title: "Dein Hund, jeden Tag ganz nah",
        body: "Mach aus deinem Lieblingsfoto einen kleinen Freund, der in deinem Garten auf dich wartet."
      },
      second: {
        step: "Schritt 2",
        title: "Ein Foto genügt",
        body: "Wähle ein klares Foto deines Hundes und ergänze seinen Namen und seine kleine Persönlichkeit."
      },
      third: {
        step: "Schritt 3",
        title: "Eure Bindung wächst jeden Tag",
        body: "Füttern, spielen, plaudern und jeden Tag in den gemütlichen Garten deines Hundes zurückkehren."
      }
    }
  },
  photoIntro: {
    accessibilityLabel: "Einführung zum Tierfoto",
    artAccessibilityLabel: "Ein Hundefoto öffnet sich zu einem kleinen Gartenzuhause",
    title: "Dein geliebter Hund in deiner Hand",
    body: "Beginne mit einem klaren Hundefoto, ergänze Name und Persönlichkeit und lerne den kleinen Freund kennen, der in deinem Garten wartet.",
    quest: {
      photo: "Foto",
      name: "Name",
      moveIn: "Einzug"
    },
    privacy: "Das Foto deines Hundes wird nur verwendet, um deinen kleinen Freund zu erschaffen. Nach dem Einzug kannst du das Original jederzeit löschen.",
    choosePhoto: "Hundefoto wählen"
  },
  photoUpload: {
  ...
  petSetup: {
    ...
    personalityQuestion: "Wie fühlt sich dein kleiner Freund heute?",
  ...
  home: {
    ...
    hud: {
      ...
      labels: { fullness: "Satt", thirst: "Wasser", mood: "Laune", energy: "Energie", cleanliness: "Sauber" },
    ...
    care: {
      actions: { feed: "Füttern", talk: "Reden", walk: "Gassi", play: "Spielen", rest: "Ruhen", affection: "Streicheln", water_garden: "Wasser", clean: "Pflegen", treat: "Leckerli" },
      ...
      tray: {
        titles: { affection: "Bindung stärken", feed: "Futter & Leckerlis", play: "Spielmöglichkeiten", walk: "Weg auswählen", water_garden: "Wasser" },
      ...
      options: { pet: "Streicheln", meal: "Mahlzeit", ball: "Ball", path: "Weg", water: "Wasser", bath: "Bad", treat: "Leckerli" },
      meta: { bond: "+Bindung", fullness: "+Satt", mood: "+Laune", thirst: "+Durst", fresh: "+Frische", shop: "Shop" }
    },
    walk: {
      ...
      commentary: { early: "{{petName}} folgt einer sehr wichtigen Spur...", mid: "{{petName}} ist stehen geblieben, um ein Blatt zu begrüßen.", late: "{{petName}} hat etwas gefunden und bringt es mit nach Hause!" },
  ...
  friend: {
    ...
    movedIn: { today: "Heute eingezogen", daysAgo: "Vor {{count}} Tagen eingezogen" },
    stats: { bond: "Bindung", streak: "Serie", together: "Zusammen", bondAccessibilityLabel: "Bindungsfortschritt bis Stufe {{level}}: {{label}}" },
    sections: { lately: "In letzter Zeit hat {{petName}}...", walkFinds: "Spaziergangsfunde", moments: "Unsere kleinen Momente", letter: "Brief von {{petName}}", memoryNote: "Erinnerungsnotiz" },
  ...
  shop: {
    ...
    categories: { treats: "Leckerlis", toysAndRest: "Spielzeug", moments: "Momente", themes: "Themen" },
    ...
    actions: { unlockTheme: "Thema freischalten", applyTheme: "Thema anwenden", getItem: "Gegenstand holen", unlockPack: "Paket freischalten" },
    grants: { consumable: "Credit", durable: "Einmalig im Besitz", subscription: "Abonnement" },
    products: {
      premiumChat: { name: "Monatlicher Plus-Chat", description: "Längere, herzlichere Gespräche, solange der Plus-Pass aktiv ist." },
      extraPetSlot: { name: "Zusätzlicher Tierplatz", description: "Schaffe Platz für ein weiteres kleines Tierprofil." },
      regenerationCredit: { name: "Credit für eine Neuerstellung", description: "Ein neuer Avatarversuch, wenn du dir einen frischen Look wünschst." },
      starterTheme: { name: "Start-Themenpaket", description: "Eine frische Kulisse für das kleine Zuhause." },
      itemPack: { name: "Gegenstandspaket", description: "Eine liebevoll zusammengestellte Auswahl an Leckerlis und Spielzeug." },
      treatPack: { name: "Leckerli-Paket", description: "Besondere Snacks für niedliche Reaktionsmomente." },
      plusPass: { name: "Plus-Pass", description: "Premium-Vorteile für eure Bindung, längere Chats und künftige Plus-Funktionen." }
    },
    actionAccessibility: {
    ...
    summary: {
      accessibilityLabel: "{{owned}} eigene Set-Gegenstände, {{locked}} gesperrte Shop-Gegenstände, {{plus}}",
      owned: "Set im Besitz",
    ...
    expressionPacks: {
      ...
      allPrice: "Alle 3 · {{credits}} Credits",
      actionAccessibilityLabel: "{{action}} aus {{name}}",
      actions: { generate: "Alle 3 erstellen", retry: "Alle 3 erneut versuchen", needCredits: "Credits benötigt", making: "Posen entstehen...", owned: "Im Profil vorhanden" }
    },
    themes: {
  ...
  settings: {
    ...
    language: { title: "App-Sprache", english: "Englisch", korean: "Koreanisch", detail: "Mongchi verwendet die Sprache deines Geräts.", action: "Ändern" },
    status: {
    ...
    sections: { reminders: "Kleine Erinnerungen", sound: "Klang & Gefühl", privacy: "Datenschutz & Fürsorge", support: "Hilfe & Rechtliches" },
    weather: {
      scenes: "Wetterszenen",
      useLocation: "Meinen Standort verwenden",
      preview: "Wettervorschau",
      next: "Als Nächstes: {{weather}}",
      locationMessages: { requesting: "Das ungefähre Wetter vor Ort wird geprüft.", ready: "Das Wetter vor Ort ist bereit.", denied: "Die Standortberechtigung wurde nicht erteilt. Du kannst das Wetter weiterhin manuell ansehen.", error: "Das Wetter vor Ort ist gerade nicht verfügbar. Nutze stattdessen eine manuelle Vorschau." },
      options: {
        clear: { label: "Klar", detail: "Standardmäßig sonniger Garten." },
        rain: { label: "Regen", detail: "Regenschicht und gemütliche Wetterzeilen." },
        snow: { label: "Schnee", detail: "Winterhintergrund und sanfte Zeilen für kalte Tage." },
        wind: { label: "Wind", detail: "Bewegte Blätter und Entdeckungen beim Spaziergang." },
        hot: { label: "Warm", detail: "Sonnige Szene und zusätzliche Hinweise zur Gartenpflege." }
      }
    },
    sound: {
      effects: "Klänge",
    ...
    reset: { title: "Zurücksetzen", detail: "Löscht die lokale Tiereinrichtung auf diesem Gerät und startet die Einführung neu.", action: "Tierdaten löschen" },
    dialogs: {
      ...
      deleteAllMessage: "Dadurch werden die Tiereinrichtung, das erstellte Tier, der Pflegestatus und das Inventar von diesem Gerät gelöscht. Außerdem bitten wir unsere Server, dein Foto, erstellte Avatare und Kontodaten zu löschen. Das lässt sich nicht rückgängig machen.",
      serverRetry: "Löschen auf dem Server erneut versuchen",
      serverRetryMessage: "Deine Gerätedaten sind gelöscht. Lass die App geöffnet und versuche es später erneut, damit auch die Serverkopie vollständig gelöscht werden kann."
    },
    restoreModal: {
  ...
  notifications: {
    channel: { name: "Gartenneuigkeiten", description: "Sanfte Neuigkeiten aus deinem Garten" },
    walkReturn: {
    ...
    garden: {
      meal_due: { title: "{{petName}} denkt gerade ans Futterschälchen", body: "Eine kleine Mahlzeit würde die Sättigung wieder in den gemütlichen Bereich bringen." },
      meal_urgent: { title: "Im Napf von {{petName}} ist heute noch Platz", body: "Eine einfache Mahlzeit wäre jetzt eine schöne Freude für {{petName}}." },
      thirst_due: { title: "Der Wassernapf von {{petName}} könnte Nachschub vertragen", body: "Ein wenig frisches Wasser würde die kleine Laune gleich aufhellen." },
      thirst_hot_weather: { title: "{{petName}} könnte einen kühlen Schluck gebrauchen", body: "Heute ist die Luft warm. Ein Napf mit frischem Wasser ist jetzt die beste erste Fürsorge." },
      bored_play: { title: "{{petName}} hat das Spielzeug wiedergefunden", body: "Eine kurze Spielrunde wäre jetzt bestimmt schön." },
      attention_return: { title: "{{petName}} hat ein kleines Hallo für dich", body: "Öffne den Garten für eine kurze Streicheleinheit, ein Gespräch oder einen kleinen Besuch." },
      walk_window: { title: "Zeit für einen kleinen Weg", body: "{{petName}} würde sich heute vielleicht über einen ruhigen Spaziergang freuen." },
      rest_needed: { title: "{{petName}} ist im Schlafmodus", body: "Eine Ruhepause hält den Rhythmus heute Abend ganz sanft." },
      rainy_cozy_check: { title: "Kleiner Regentagsgruß", body: "{{petName}} macht es sich gemütlich. Ein Hallo würde gut zum Wetter passen." },
      return_after_1_day: { title: "An der Tür ist ein kleiner Pfotenabdruck aufgetaucht", body: "{{petName}} fragt sich schon, wann du wieder hereinschaust." },
      return_after_1_day_streak: { title: "{{petName}} hält eure kleine Routine gemütlich", body: "Deine Serie ist noch warm. Ein kurzer Besuch heute lässt sie weiterleuchten." },
      return_after_3_days: { title: "Der Garten hat dir einen Platz freigehalten", body: "Ein paar Tage sind vergangen. {{petName}} freut sich über ein kurzes Hallo, wenn du bereit bist." }
    }
  },
  errorBoundary: {
  ...
  legal: {
    ...
    privacy: {
      ...
      items: {
        ...
        second: "Das Originalfoto deines Tieres wird nur für die Sicherheitsprüfung und Avatarerstellung an OpenAI gesendet. Sobald die Erstellung abgeschlossen ist, wird es automatisch von unseren Servern gelöscht.",
        third: "Wenn du später weitere Ausdrucksformen freischaltest, wird der bereits erstellte Avatar verwendet, nicht dein Originalfoto. Zu diesem Zeitpunkt ist es auf unseren Servern nicht mehr vorhanden.",
        fourth: "Erstellte Avatare liegen in einem privaten Speicherbereich und werden nur über kurzzeitig gültige, signierte Links angezeigt, niemals über eine öffentliche URL.",
        fifth: "Pflegewerte, Erinnerungen und Gartenfortschritt werden lokal auf deinem Gerät gespeichert. Wenn du die App deinstallierst, werden sie dauerhaft entfernt.",
        sixth: "Wenn du es erlaubst, wird dein ungefährer Standort einmalig für eine Wetterabfrage verwendet und nicht auf unseren Servern gespeichert.",
      ...
      sections: {
        ...
        childrenBody: "Mongchi richtet sich nicht an Kinder unter 13 Jahren. Wenn du glaubst, dass ein Kind über ein Foto oder einen Chat Informationen bereitgestellt hat, wende dich an den Support. Wir löschen diese Daten."
      },
    ...
    support: {
      ...
      faq: {
        ...
        photoAnswer: "Dein Foto wird nur für eine Sicherheitsprüfung und die Avatarerstellung verwendet. Nach Abschluss der Erstellung wird es automatisch von unseren Servern gelöscht.",
        deleteQuestion: "Wie lösche ich meine Daten?",
        deleteAnswer: "Lösche das Originalfoto während des Fotoablaufs separat oder wähle in den Einstellungen „Tierdaten löschen“, um eine vollständige lokale Löschung und Serverlöschung anzufordern.",
        creditQuestion: "Was passiert mit meinen Credits, wenn die Erstellung fehlschlägt?",
        creditAnswer: "Ein Systemfehler oder eine fehlgeschlagene Sicherheits- oder Qualitätsprüfung sollte keinen bezahlten Credit kosten. Melde es unten, falls ein Credit zu Unrecht verbraucht wurde."
      },
      ...
      options: {
        wrong: { label: "Sieht anders aus", description: "Tierart, Zeichnung oder Gesicht wirken nicht richtig." },
        unsafe: { label: "Unangenehmes Aussehen", description: "Etwas wirkt unangenehm oder beängstigend." },
        quality: { label: "Unscharfes Ergebnis", description: "Das Tier ist schwer zu erkennen." }
      },
      report: "Melden",
      saved: "Gespeichert",
    ...
    terms: {
      ...
      updated: "Zuletzt aktualisiert am 7. Juli 2026 · v1.0",
      items: {
        first: "Mongchi ist KI-generierte Unterhaltung. Dein Gefährte und der Chat sind weder das Bewusstsein oder die Erinnerung deines echten Tieres noch eine medizinische Beratung.",
      ...
      sections: {
        ...
        useBody: "Lade keine Fotos hoch, die Personen, explizite oder drastische Inhalte oder rechtswidrige Inhalte zeigen. Umgehe keine Erstellungslimits oder Sicherheitsprüfungen und versuche nicht, den Chat zu manipulieren.",
        portabilityTitle: "Keine Kontoübertragbarkeit",
        portabilityBody: "Mongchi verwendet keine klassischen Konten. Sitzungsdaten und lokale Spieldaten liegen auf deinem Gerät. Wenn du die App ohne Sicherung deinstallierst oder das Gerät wechselst, können lokaler Fortschritt, Erinnerungen und Credits dauerhaft verloren gehen.",
        disclaimerTitle: "Haftungsausschluss",
        disclaimerBody: "Mongchi wird im aktuellen Zustand bereitgestellt. KI-generierte Inhalte können trotz Sicherheits- und Qualitätsprüfungen gelegentlich ungenau sein oder nicht erstellt werden. Die vollständigen Einschränkungen findest du in den vollständigen Bedingungen."
      },
