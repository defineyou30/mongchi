...
export const esMX = {
  ...
  welcome: {
    ...
    slides: {
      first: {
        step: "Paso 1",
        title: "Tu perrito, cerca cada día",
        body: "Convierte una foto favorita de tu perrito en un pequeño amigo que te espera en su jardín."
      },
      second: {
        step: "Paso 2",
        title: "Solo necesitas una foto",
        body: "Elige una foto clara de tu perrito y agrega su nombre y su tierna personalidad."
      },
      third: {
        step: "Paso 3",
        title: "Fortalezcan su vínculo cada día",
        body: "Dale de comer, juega, charla y vuelve cada día al acogedor jardín de tu perrito."
      }
    }
  },
  photoIntro: {
    accessibilityLabel: "Introducción a la foto de tu mascota",
    artAccessibilityLabel: "Una foto de un perrito que se abre hacia un pequeño hogar en el jardín",
    title: "Cuida a tu querido perrito en la palma de tu mano",
    body: "Empieza con una foto clara de tu perrito, agrega su nombre y personalidad, y conoce al pequeño amigo que te espera en el jardín.",
    quest: {
      photo: "Foto",
      name: "Nombre",
      moveIn: "Mudanza"
    },
    privacy: "La foto de tu perrito solo se usa para crear a tu pequeño amigo. Puedes eliminar la original cuando termine su mudanza.",
    choosePhoto: "Elegir foto del perrito"
  },
  photoUpload: {
  ...
  petSetup: {
    ...
    personalityQuestion: "¿Cómo se siente tu amiguito hoy?",
  ...
  home: {
    ...
    hud: {
      ...
      labels: { fullness: "Saciado", thirst: "Agua", mood: "Ánimo", energy: "Energía", cleanliness: "Limpio" },
    ...
    care: {
      actions: { feed: "Alimentar", talk: "Hablar", walk: "Pasear", play: "Jugar", rest: "Descansar", affection: "Acariciar", water_garden: "Regar", clean: "Limpiar", treat: "Premio" },
      ...
      tray: {
        titles: { affection: "Impulsores del vínculo", feed: "Comida y premios", play: "Opciones de juego", walk: "Opciones de ruta", water_garden: "Agua" },
      ...
      options: { pet: "Caricias", meal: "Comida", ball: "Pelota", path: "Ruta", water: "Agua", bath: "Baño", treat: "Premio" },
      meta: { bond: "+Vínculo", fullness: "+Saciedad", mood: "+Ánimo", thirst: "+Hidratación", fresh: "+Frescura", shop: "Tienda" }
    },
    walk: {
      ...
      commentary: { early: "{{petName}} sigue un aroma muy importante...", mid: "{{petName}} se detuvo a saludar una hoja.", late: "¡{{petName}} encontró algo y lo lleva a casa!" },
  ...
  friend: {
    ...
    stats: { bond: "Vínculo", streak: "Racha", together: "Juntos", bondAccessibilityLabel: "Progreso del vínculo hacia el nivel {{level}}: {{label}}" },
    sections: { lately: "Últimamente, {{petName}}...", walkFinds: "Hallazgos del paseo", moments: "Nuestros pequeños momentos", letter: "Carta de {{petName}}", memoryNote: "Nota de recuerdo" },
  ...
  shop: {
    ...
    categories: { treats: "Premios", toysAndRest: "Juguetes", moments: "Momentos", themes: "Temas" },
    ...
    actions: { unlockTheme: "Desbloquear tema", applyTheme: "Aplicar tema", getItem: "Obtener artículo", unlockPack: "Desbloquear paquete" },
    grants: { consumable: "Crédito", durable: "Adquisición permanente", subscription: "Suscripción" },
    products: {
      premiumChat: { name: "Chat mensual Plus", description: "Charlas más largas y cálidas mientras el pase Plus esté activo." },
      extraPetSlot: { name: "Espacio extra para mascota", description: "Haz lugar para un perfil más de pequeña mascota." },
      regenerationCredit: { name: "Crédito de regeneración", description: "Un nuevo intento de avatar cuando quieras un aspecto fresco." },
      starterTheme: { name: "Paquete de tema inicial", description: "Un fondo renovado para el pequeño hogar." },
      itemPack: { name: "Paquete de artículos", description: "Una selección especial de premios y juguetes." },
      treatPack: { name: "Paquete de premios", description: "Bocaditos especiales para momentos de reacciones tiernas." },
      plusPass: { name: "Pase Plus", description: "Ventajas especiales para el vínculo, con charlas más largas y futuras funciones Plus." }
    },
    actionAccessibility: {
    ...
    summary: {
      accessibilityLabel: "{{owned}} artículos del conjunto en propiedad, {{locked}} artículos bloqueados en la tienda, {{plus}}",
    ...
    expressionPacks: {
      ...
      allPrice: "Las 3 · {{credits}} créditos",
      actionAccessibilityLabel: "{{action}} de {{name}}",
      actions: { generate: "Generar las 3", retry: "Reintentar las 3", needCredits: "Necesitas créditos", making: "Creando poses...", owned: "Adquiridas en el perfil" }
    },
    themes: {
  ...
  settings: {
    ...
    language: { title: "Idioma de la aplicación", english: "Inglés", korean: "Coreano", detail: "Mongchi usa el idioma de tu dispositivo.", action: "Cambiar" },
    status: {
    ...
    sections: { reminders: "Pequeños recordatorios", sound: "Sonido y sensación", privacy: "Privacidad y cuidado", support: "Ayuda y asuntos legales" },
    weather: {
      scenes: "Escenas del clima",
      useLocation: "Usar mi ubicación",
      preview: "Vista previa del clima",
      next: "Siguiente: {{weather}}",
      locationMessages: { requesting: "Consultando el clima local aproximado.", ready: "El clima local está listo.", denied: "No se otorgó permiso de ubicación. Aún puedes probar el clima manualmente.", error: "El clima local no está disponible en este momento. Prueba una vista previa manual." },
      options: {
        clear: { label: "Despejado", detail: "Jardín soleado predeterminado." },
        rain: { label: "Lluvia", detail: "Efecto de lluvia y frases acogedoras sobre el clima." },
        snow: { label: "Nieve", detail: "Fondo invernal y frases suaves sobre el frío." },
        wind: { label: "Viento", detail: "Movimiento de hojas y descubrimientos en el paseo." },
        hot: { label: "Cálido", detail: "Escena soleada y más sugerencias para cuidar el jardín." }
      }
    },
    sound: {
      effects: "Sonidos",
    ...
    reset: { title: "Restablecer", detail: "Elimina la configuración local de la mascota en este dispositivo y vuelve a iniciar la bienvenida.", action: "Eliminar datos de la mascota" },
    dialogs: {
      ...
      deleteAllMessage: "Esto elimina de este dispositivo la configuración de la mascota, la mascota generada, el estado de sus cuidados y el inventario. También solicita a nuestros servidores que eliminen tu foto, los avatares generados y los datos de la cuenta. Esta acción no se puede deshacer.",
      serverRetry: "Hay que reintentar la eliminación del servidor",
      serverRetryMessage: "Los datos de tu dispositivo ya se borraron. Mantén la aplicación abierta e inténtalo de nuevo más tarde para completar también la eliminación de la copia del servidor."
    },
    restoreModal: {
  ...
  notifications: {
    channel: { name: "Novedades del jardín", description: "Novedades amables sobre tu jardín" },
    walkReturn: {
    ...
    garden: {
      meal_due: { title: "{{petName}} está pensando en su platito", body: "Una pequeña comida le devolvería una saciedad agradable." },
      meal_urgent: { title: "Hoy queda espacio en el platito de {{petName}}", body: "Una comida básica sería un lindo premio para {{petName}} ahora mismo." },
      thirst_due: { title: "Al platito de agua de {{petName}} le vendría bien un poco más", body: "Darle agua alegraría un poquito su ánimo." },
      thirst_hot_weather: { title: "A {{petName}} le vendría bien un traguito fresco", body: "Hoy se siente caluroso. Un platito con agua fresca es el mejor primer cuidado." },
      bored_play: { title: "{{petName}} volvió a encontrar el juguete", body: "Un ratito de juego suena divertido ahora mismo." },
      attention_return: { title: "{{petName}} tiene un saludito preparado", body: "Abre el jardín para darle una caricia, hablarle o ver cómo está." },
      walk_window: { title: "Hora del pequeño sendero", body: "Quizá {{petName}} disfrute hoy un paseo tranquilo." },
      rest_needed: { title: "{{petName}} está en modo dormilón", body: "Un descanso mantendrá un ritmo tranquilo esta noche." },
      rainy_cozy_check: { title: "Un pequeño saludo bajo la lluvia", body: "{{petName}} está muy a gusto. Un saludo le quedaría perfecto a este clima." },
      return_after_1_day: { title: "Apareció una huellita junto a la puerta", body: "{{petName}} se preguntaba cuándo volverías a pasar por aquí." },
      return_after_1_day_streak: { title: "{{petName}} mantiene acogedora su pequeña rutina", body: "Tu racha sigue calientita. Una visita rápida hoy mantendrá su brillo." },
      return_after_3_days: { title: "El jardín guardó un lugar para ti", body: "Han pasado unos días. A {{petName}} le encantará recibir un saludito cuando quieras." }
    }
  },
  errorBoundary: {
  ...
  legal: {
    ...
    privacy: {
      ...
      items: {
        ...
        second: "La foto original de tu mascota se envía a OpenAI solo para realizar una revisión de seguridad y generar el avatar. Después, se elimina automáticamente de nuestros servidores en cuanto termina la generación.",
        third: "Al desbloquear más expresiones después, se reutiliza la ilustración del avatar ya generado, no la foto original, pues para entonces ya no existe en nuestros servidores.",
        fourth: "Los avatares generados se guardan en un depósito privado y solo se muestran mediante enlaces firmados de corta duración, nunca con una URL pública.",
        fifth: "Las estadísticas de cuidado, los recuerdos y el progreso del jardín se guardan localmente en tu dispositivo, por lo que desinstalar la aplicación los elimina de forma permanente.",
        sixth: "Si lo permites, tu ubicación aproximada se usa una sola vez para consultar el clima y no se guarda en nuestros servidores.",
        seventh: "El chat de pago se identifica como generado por IA y se modera antes de mostrar los mensajes.",
        eighth: "No usamos kits de desarrollo para anuncios o rastreo, y los análisis evitan las fotos originales, el texto original del chat y los datos de pago."
      },
      sections: {
        sharingTitle: "Terceros con quienes compartimos datos",
        sharingBody: "OpenAI procesa la foto original de tu mascota para las revisiones de seguridad y la generación del avatar. Para el chat de pago, procesa el perfil de tu mascota y el contexto reciente de la conversación. Supabase aloja nuestra base de datos, almacenamiento privado y autenticación anónima. Apple o Google gestionan directamente los pagos dentro de la aplicación; nosotros recibimos un comprobante, nunca los datos de tu tarjeta.",
        rightsTitle: "Tus derechos",
        rightsBody: "Puedes eliminar la foto original por separado. Para borrar todo, elige Eliminar datos de la mascota en Configuración. Esto borra los datos locales y solicita a nuestros servidores que eliminen la foto, los avatares generados, la cuenta anónima y los registros relacionados. Si no se puede contactar al servidor, los datos locales se borran de inmediato y la aplicación te pide reintentar más tarde el paso del servidor.",
        childrenTitle: "Menores",
        childrenBody: "Mongchi no está dirigido a menores de 13 años. Si crees que un menor proporcionó información mediante una foto o un chat, comunícate con el equipo de ayuda y la eliminaremos."
      },
    ...
    support: {
      ...
      faq: {
        ...
        photoAnswer: "Tu foto solo se usa para una revisión de seguridad y para generar el avatar. Se elimina automáticamente de nuestros servidores cuando termina la generación.",
        deleteQuestion: "¿Cómo elimino mis datos?",
        deleteAnswer: "Elimina la foto original por separado durante el proceso de la foto, o usa Eliminar datos de la mascota en Configuración para solicitar la eliminación completa de los datos locales y del servidor.",
        creditQuestion: "¿Qué pasa con mis créditos si falla la generación?",
        creditAnswer: "Una falla del sistema, de seguridad o de la revisión de calidad no debería consumir un crédito pagado. Repórtala abajo si parece que se usó un crédito de manera injusta."
      },
      ...
      options: {
        wrong: { label: "No se parece", description: "La especie, las marcas o la cara no se ven bien." },
        unsafe: { label: "Aspecto inquietante", description: "Algo resulta incómodo o da miedo." },
        quality: { label: "Resultado borroso", description: "Es difícil reconocer a la mascota." }
      },
      report: "Reportar",
      saved: "Guardado",
    ...
    terms: {
      ...
      updated: "Última actualización: 7 de julio de 2026 · v1.0",
      items: {
        first: "Mongchi es entretenimiento generado por IA; tu compañero y el chat no son la conciencia ni la memoria de tu mascota real, ni ofrecen asesoría médica.",
      ...
      sections: {
        ...
        useBody: "No subas fotos que contengan personas, contenido explícito o gráfico, ni nada ilegal. No evadas los límites de generación o las revisiones de seguridad, ni intentes vulnerar el chat.",
        portabilityTitle: "Sin portabilidad de cuenta",
        portabilityBody: "Mongchi no usa cuentas tradicionales. Los datos de la sesión y del juego local viven en tu dispositivo, así que desinstalar la aplicación o cambiar de dispositivo sin un respaldo puede causar la pérdida permanente del progreso local, los recuerdos y los créditos.",
        disclaimerTitle: "Descargo de responsabilidad",
        disclaimerBody: "Mongchi se proporciona tal cual. El contenido generado por IA puede ser inexacto o fallar de vez en cuando, incluso con revisiones de seguridad y calidad. Consulta los términos completos para conocer todas las limitaciones."
      },
