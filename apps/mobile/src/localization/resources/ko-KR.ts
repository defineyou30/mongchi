...
export const koKR = {
  ...
  welcome: {
    ...
    start: "사진으로 시작하기",
    slides: {
      first: { step: "1단계", title: "매일 곁에 있는 우리 강아지", body: "좋아하는 강아지 사진 한 장으로 정원에서 기다리는 작은 친구를 만나보세요." },
      second: { step: "2단계", title: "사진 한 장이면 충분해요", body: "강아지가 선명하게 나온 사진을 고르고 이름과 작은 성격을 알려 주세요." },
      third: { step: "3단계", title: "매일 유대감을 키워요", body: "밥을 주고, 놀고, 대화하며 매일 포근한 정원으로 돌아오세요." }
    }
  },
  photoIntro: {
    accessibilityLabel: "반려견 사진 시작 안내",
    artAccessibilityLabel: "강아지 사진 한 장이 작은 정원 집으로 이어지는 모습",
    title: "사랑하는 강아지를 손안에서 키워보세요",
    body: "강아지가 선명하게 나온 사진 한 장과 이름, 성격을 알려주면 정원에서 기다리는 작은 친구를 만날 수 있어요.",
    quest: { photo: "사진", name: "이름", moveIn: "입주" },
    privacy: "강아지 사진은 작은 친구를 만드는 데만 사용돼요. 입주가 끝나면 언제든 원본을 삭제할 수 있어요.",
    choosePhoto: "강아지 사진 선택"
  },
  photoUpload: {
    accessibilityLabel: "반려견 사진 업로드",
    back: "사진 안내로 돌아가기",
    title: "가장 잘 나온 사진을 골라주세요",
    artAccessibilityLabel: "안전한 반려견 사진 선택 보드",
    changeSelected: "선택한 반려견 사진 변경",
    choosePhoto: "반려견 사진 선택",
    selectedPreview: "{{petName}}의 선택된 반려견 사진 미리보기",
    selectedSamplePreview: "{{petName}}의 선택된 샘플 사진 미리보기",
    samplePreview: "샘플 반려견 사진 미리보기",
    sampleSelected: "샘플 사진을 선택했어요",
    photoSelected: "반려견 사진을 선택했어요",
    ...
    errors: {
      ...
      libraryMessage: "작은 친구를 만들 반려견 사진 한 장을 선택해 주세요.",
      cameraTitle: "카메라 권한이 필요해요",
      cameraMessage: "카메라 권한은 반려견 사진을 직접 촬영할 때만 사용돼요."
    }
  },
  petSetup: {
    accessibilityLabel: "반려견 설정",
    back: "사진으로 돌아가기",
    ...
    personalityQuestion: "오늘 우리 친구의 기분은 어떤가요?",
    ...
    personality: { playful: "장난꾸러기", calm: "차분함", shy: "수줍음", curious: "호기심 많음", sleepy: "졸림", affectionate: "다정함" },
    voice: { cute: "귀엽게", gentle: "다정하게", cheerful: "발랄하게", comforting: "포근하게" }
  },
  generation: {
    ...
    stepsTitle: "오는 길",
    reveal: "친구 만나기",
    steps: { preparing: "사진 준비", details: "작은 특징 찾기", creating: "친구 만들기", polishing: "작은 세상 다듬기", movingIn: "입주하기" },
    observations: {
    ...
    warmLines: { first: "따뜻한 손길이 닿자 알이 살짝 움직였어요!", second: "알이 한결 포근해졌어요.", third: "작은 심장 소리가 고맙다고 인사했어요.", fourth: "거의 다 왔어요. 손길이 큰 힘이 되고 있어요." },
    statuses: {
      created: "작은 작업실을 데우고 있어요.", queued: "입주할 자리를 기다리고 있어요.", claimed: "작은 작업실 문을 열고 있어요.", validating: "사진 속 특징을 확인하고 있어요.", preprocessing: "사진을 준비하고 있어요.", safety_checking: "안전하게 입주할 수 있는지 확인하고 있어요.", generating: "첫 번째 작은 친구를 만들고 있어요.", postprocessing: "털과 마지막 디테일을 다듬고 있어요.", quality_checking: "마지막 모습을 확인하고 있어요.", uploading_assets: "집으로 갈 짐을 챙기고 있어요.", cleanup_pending: "입주 전에 사진을 깔끔히 정리하고 있어요.", completed: "만날 준비가 됐어요.", failed: "입주가 잠시 멈췄어요.", cancelled: "입주가 중단됐어요.", expired: "입주 시간이 만료됐어요."
    },
    teaser: {
      playful: "장난꾸러기 친구가 짐을 챙기고 있어요...", calm: "차분한 친구가 짐을 챙기고 있어요...", shy: "조금 수줍은 친구가 짐을 챙기고 있어요...", curious: "호기심 많은 친구가 짐을 챙기고 있어요...", sleepy: "졸린 친구가 짐을 챙기고 있어요...", affectionate: "다정한 친구가 짐을 챙기고 있어요...", fallback: "사랑스러운 친구가 짐을 챙기고 있어요..."
    },
  ...
  home: {
    ...
    hud: {
      ...
      labels: { fullness: "배부름", thirst: "물", mood: "기분", energy: "에너지", cleanliness: "청결" },
    ...
    care: {
      actions: { feed: "밥", talk: "대화", walk: "산책", play: "놀이", rest: "휴식", affection: "쓰다듬기", water_garden: "물", clean: "목욕", treat: "간식" },
      ...
      tray: {
        titles: { affection: "유대감 선물", feed: "밥과 간식", play: "놀이 선택", walk: "산책길 선택", water_garden: "물과 목욕" },
      ...
      options: { pet: "쓰다듬기", meal: "밥", ball: "공", path: "산책길", water: "물", bath: "목욕", treat: "간식" },
      meta: { bond: "+유대감", fullness: "+배부름", mood: "+기분", thirst: "+갈증", fresh: "+청결", shop: "상점" }
    },
    walk: {
      ...
      commentary: { early: "{{petName}}가 아주 중요한 냄새를 따라가고 있어요...", mid: "{{petName}}가 나뭇잎 친구에게 인사했어요.", late: "{{petName}}가 무언가를 발견해 집으로 가져오고 있어요!" },
  ...
  friend: {
    ...
    back: "홈으로 돌아가기",
    share: "{{petName}} 공유하기",
    movedIn: { today: "오늘 입주했어요", daysAgo: "입주한 지 {{count}}일 됐어요" },
    stats: { bond: "유대감", streak: "연속 돌봄", together: "함께한 시간", bondAccessibilityLabel: "레벨 {{level}}까지의 유대감 진행: {{label}}" },
    sections: { lately: "요즘 {{petName}}는...", walkFinds: "산책 발견물", moments: "우리의 작은 순간", letter: "{{petName}}의 편지", memoryNote: "추억 메모" },
  ...
  shop: {
    ...
    categories: { treats: "간식", toysAndRest: "장난감", moments: "순간", themes: "테마" },
    ...
    actions: { unlockTheme: "테마 열기", applyTheme: "테마 적용", getItem: "아이템 받기", unlockPack: "팩 열기" },
    grants: { consumable: "크레딧", durable: "1회 보유", subscription: "구독" },
    products: {
      premiumChat: { name: "Plus 월간 채팅", description: "Plus 패스가 활성화된 동안 더 길고 포근하게 대화해요." },
      extraPetSlot: { name: "추가 친구 자리", description: "작은 친구 프로필을 하나 더 만들 수 있어요." },
      regenerationCredit: { name: "다시 만들기 크레딧", description: "새로운 모습이 필요할 때 아바타를 한 번 다시 만들어요." },
      starterTheme: { name: "기본 테마 팩", description: "작은 집에 새로운 배경을 선물해요." },
      itemPack: { name: "아이템 팩", description: "간식과 장난감을 포근하게 모은 팩이에요." },
      treatPack: { name: "간식 팩", description: "귀여운 반응을 만나는 특별한 간식 모음이에요." },
      plusPass: { name: "Plus 패스", description: "긴 대화와 앞으로의 Plus 기능을 위한 특별한 유대감 혜택이에요." }
    },
    actionAccessibility: {
    ...
    summary: {
      accessibilityLabel: "보유 아이템 {{owned}}개, 잠긴 상점 아이템 {{locked}}개, {{plus}}",
      owned: "보유 아이템",
    ...
    expressionPacks: {
      title: "포즈 팩",
      description: "한 팩으로 지금 모습에서 새로운 포즈 3개를 만들어요.",
      poseCount: "포즈 3개",
      boardAccessibilityLabel: "{{name}}, 포즈 3개 팩, {{price}}. {{status}}",
      creditGemAccessibilityLabel: "크레딧 보석",
      allOwned: "3개 모두 보유 중",
      allPrice: "3개 모두 · 크레딧 {{credits}}개",
      actionAccessibilityLabel: "{{name}}에서 {{action}}",
      actions: { generate: "3개 모두 만들기", retry: "3개 모두 다시 시도", needCredits: "크레딧 필요", making: "포즈 만드는 중...", owned: "프로필에 보관 중" }
    },
    themes: {
      defaultName: "포근한 정원",
  ...
  settings: {
    ...
    language: { title: "앱 언어", english: "영어", korean: "한국어", detail: "기기 설정에 따라 몽치의 언어가 바뀌어요.", action: "변경" },
    status: {
      needsCheck: "확인 필요",
      syncing: "동기화 중",
    ...
    sections: { reminders: "작은 알림", sound: "소리와 느낌", privacy: "개인정보와 돌봄", support: "도움말과 약관" },
    weather: {
      scenes: "날씨 장면",
      useLocation: "내 위치 사용",
      preview: "날씨 미리보기",
      next: "다음: {{weather}}",
      locationMessages: { requesting: "대략적인 지역 날씨를 확인하고 있어요.", ready: "지역 날씨를 준비했어요.", denied: "위치 권한을 허용하지 않았어요. 수동 날씨 미리보기는 계속 사용할 수 있어요.", error: "지금은 지역 날씨를 불러올 수 없어요. 수동 미리보기를 사용해 주세요." },
      options: {
        clear: { label: "맑음", detail: "기본 햇살 정원이에요." },
        rain: { label: "비", detail: "빗방울과 포근한 날씨 대사가 나타나요." },
        snow: { label: "눈", detail: "겨울 배경과 부드러운 추위 대사가 나타나요." },
        wind: { label: "바람", detail: "나뭇잎이 움직이고 산책 발견물이 찾아와요." },
        hot: { label: "따뜻함", detail: "맑은 장면과 정원 돌봄 안내가 더해져요." }
      }
    },
    sound: {
      effects: "효과음",
    ...
    reset: { title: "초기화", detail: "이 기기의 반려동물 설정을 삭제하고 온보딩을 다시 시작해요.", action: "반려동물 데이터 삭제" },
    dialogs: {
      errorLog: "오류 기록",
      ...
      deleteAllMessage: "이 기기의 반려동물 설정, 생성된 친구, 돌봄 상태와 보관함을 삭제하고 서버에도 사진, 아바타와 계정 데이터 삭제를 요청해요. 되돌릴 수 없어요.",
  ...
  notifications: {
    channel: { name: "정원 소식", description: "작은 정원의 포근한 소식을 전해드려요" },
    walkReturn: {
    ...
    garden: {
      meal_due: { title: "{{petName}}가 밥그릇을 바라보고 있어요", body: "작은 식사로 배부름을 포근하게 채워주세요." },
      meal_urgent: { title: "{{petName}}의 밥그릇이 비어가요", body: "지금 기본 식사를 챙겨주면 {{petName}}가 좋아할 거예요." },
      thirst_due: { title: "{{petName}}의 물그릇을 채워주세요", body: "신선한 물 한 그릇이면 작은 기분도 밝아져요." },
      thirst_hot_weather: { title: "{{petName}}에게 시원한 물이 필요해요", body: "오늘은 공기가 따뜻해요. 먼저 신선한 물을 챙겨주세요." },
      bored_play: { title: "{{petName}}가 장난감을 찾았어요", body: "지금 짧게 놀아주면 즐거운 시간이 될 거예요." },
      attention_return: { title: "{{petName}}가 작은 인사를 준비했어요", body: "정원을 열어 쓰다듬거나 이야기를 나눠보세요." },
      walk_window: { title: "작은 산책 시간", body: "오늘 {{petName}}와 차분한 산책을 즐겨보세요." },
      rest_needed: { title: "{{petName}}가 졸려 보여요", body: "오늘 밤은 포근하게 쉬도록 도와주세요." },
      rainy_cozy_check: { title: "비 오는 날의 작은 안부", body: "{{petName}}가 포근하게 쉬고 있어요. 인사를 건네보세요." },
      return_after_1_day: { title: "문 앞에 작은 발자국이 생겼어요", body: "{{petName}}가 언제 돌아올지 기다리고 있어요." },
      return_after_1_day_streak: { title: "{{petName}}가 작은 일상을 포근하게 지키고 있어요", body: "연속 돌봄은 아직 따뜻해요. 오늘 잠깐 만나면 반짝임이 이어져요." },
      return_after_3_days: { title: "정원이 자리를 남겨두었어요", body: "며칠이 지났어요. 편할 때 {{petName}}에게 짧게 인사해 주세요." }
    }
  },
  errorBoundary: {
    fallbackPetName: "우리 친구",
  ...
  legal: {
    ...
    privacy: {
      ...
      items: {
        ...
        sixth: "허용한 대략적인 위치는 날씨 확인에 한 번 사용되며 서버에 저장하지 않아요.",
      ...
      sections: {
        ...
        sharingBody: "OpenAI는 사진 안전 확인과 아바타 생성, 프리미엄 채팅의 프로필과 최근 대화 맥락을 처리해요. Supabase는 데이터베이스, 비공개 저장소와 익명 인증을 제공해요. 인앱 결제는 Apple 또는 Google이 직접 처리하며 Mongchi는 카드 정보가 아닌 영수증만 받아요.",
        rightsTitle: "사용자의 권리",
        rightsBody: "원본 사진은 따로 삭제할 수 있어요. 전체 삭제는 설정의 반려동물 데이터 삭제를 이용하세요. 기기 데이터를 지우고 서버에 사진, 아바타, 익명 계정과 연결된 기록 삭제를 요청해요. 서버에 닿지 않아도 기기 데이터는 바로 지우고 서버 작업은 나중에 다시 안내해요.",
        childrenTitle: "어린이",
        childrenBody: "Mongchi는 만 13세 미만 어린이를 대상으로 하지 않아요. 어린이가 사진이나 채팅을 통해 정보를 제공했다고 생각되면 도움말로 연락해 주세요. 관련 정보를 삭제할게요."
      },
      policyLink: "정책 링크",
    ...
    support: {
      ...
      options: {
        wrong: { label: "모습이 달라요", description: "종류, 무늬 또는 얼굴이 어색해 보여요." },
        unsafe: { label: "불편한 모습", description: "불편하거나 무섭게 느껴지는 부분이 있어요." },
        quality: { label: "흐린 결과", description: "반려동물을 알아보기 어려워요." }
      },
      report: "신고",
      saved: "저장됨",
    ...
    terms: {
      ...
      sections: {
        useTitle: "허용되는 이용",
        useBody: "사람, 노골적이거나 잔인한 내용 또는 불법적인 내용이 담긴 사진을 올리지 마세요. 생성 제한이나 안전 확인을 우회하거나 채팅을 탈옥하려 하지 마세요.",
        portabilityTitle: "계정 이동성 없음",
        portabilityBody: "Mongchi는 일반 계정을 사용하지 않아요. 세션과 게임 데이터는 기기에 있으므로 백업 없이 앱을 삭제하거나 기기를 바꾸면 진행, 추억과 크레딧을 잃을 수 있어요.",
        disclaimerTitle: "면책 안내",
        disclaimerBody: "Mongchi는 현재 상태로 제공돼요. AI 생성 콘텐츠는 안전 및 품질 확인에도 가끔 부정확하거나 생성에 실패할 수 있어요. 자세한 제한은 전체 약관을 확인해 주세요."
      },
      linkTitle: "약관 링크",
