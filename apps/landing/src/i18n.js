...
const ENGLISH = {
  ...
  "meta.landing.description": "Turn a favorite dog or cat photo into a pixel companion. Care, chat, play, and collect memories together. Chat replies are AI-generated.",
  ...
  "hero.lead": "Turn a favorite photo of your dog or cat into a tiny pixel companion to care for, chat with, and play with.",
...
const COPY = {
  ...
  "ko-KR": {
    ...
    "meta.landing.description": "강아지나 고양이 사진 한 장이 AI 픽셀 친구가 돼요. 함께 돌보고, 대화하고, 놀며 소중한 추억을 모아 보세요.",
    ...
    "hero.lead": "강아지나 고양이 사진 한 장으로, 함께 돌보고 대화하고 놀 수 있는 작은 픽셀 친구를 만나 보세요.",
    ...
    "care.chatBody": "AI가 만든 답변임을 알려 드려요. 우리 아이를 닮은 친구와 다정하게 이야기해요.",
  ...
  "ja-JP": {
    ...
    "meta.landing.description": "愛犬や愛猫の写真一枚が、小さなピクセルペットに。お世話も、おしゃべりも、遊びも楽しみながら、毎日の思い出を集めるペットアプリです。",
    ...
    "hero.lead": "お気に入りの一枚から生まれた小さなピクセルペットと、お世話も、おしゃべりも、遊びも楽しめます。",
    ...
    "photo.lead": "はっきり写った写真を選ぶと、ピクセルになったうちの子との毎日が始まります。",
    ...
    "care.lead": "お世話や遊び、おしゃべりを楽しみ、思い出を集めていく。実際のアプリ画面で、うちの子との毎日をのぞいてみてください。",
    "care.gentleTitle": "自分のペースで",
    "care.gentleBody": "お休みする日があっても大丈夫。",
    "care.chatTitle": "うちの子らしいおしゃべり",
    "care.chatBody": "返事はAIがつくります。うちの子らしく答えます。",
  ...
  "zh-TW": {
    ...
    "meta.landing.description": "把一張喜歡的狗狗或貓咪照片變成像素夥伴，照顧牠、和牠聊天玩耍，一起收藏日常回憶。",
    ...
    "hero.lead": "選一張喜歡的狗狗或貓咪照片，照片中的牠就會化身像素夥伴，住進你的手機裡。",
    "hero.primary": "準備迎接牠",
    ...
    "photo.lead": "選一張清楚的毛孩照片，就能遇見牠的像素模樣，從此每天相伴。",
  ...
  "de-DE": {
    ...
    "meta.landing.description": "Aus einem Foto deines Hundes oder deiner Katze wird ein Pixelbegleiter. Kümmere dich um ihn, chatte und spiele mit ihm und sammle gemeinsame Erinnerungen.",
    ...
    "hero.lead": "Mach aus einem Lieblingsfoto deines Hundes oder deiner Katze einen kleinen Pixelbegleiter, um den du dich kümmerst, mit dem du chattest, spielst und Erinnerungen sammelst.",
    ...
    "download.title": "Dein Pixelbegleiter für unterwegs.",
  ...
  "fr-FR": {
    ...
    "meta.landing.description": "Une photo de votre chien ou de votre chat devient un compagnon en pixels. Prenez-en soin, discutez avec lui grâce à l’IA, jouez et collectionnez vos souvenirs.",
    ...
    "hero.lead": "Une photo de votre chien ou de votre chat suffit pour donner vie à un petit compagnon en pixels, prêt à partager votre quotidien.",
  ...
  "pt-BR": {
    ...
    "meta.landing.description": "Uma foto do seu cachorro ou gato vira um companheiro em pixels. Cuide dele, converse, brinque e guarde memórias no MongChi.",
    ...
    "hero.lead": "Transforme uma foto do seu cachorro ou gato em um companheiro em pixels. Cuide dele, converse, brinque e guarde as memórias de vocês.",
  ...
  "es-MX": {
    ...
    "meta.landing.description": "Convierte una foto de tu perro o gato en una mascota pixel. Cuídala, platica y juega con ella mientras coleccionan recuerdos juntos en MongChi.",
    ...
    "hero.lead": "Convierte una foto de tu perro o gato en su versión pixel para cuidarla, platicar y jugar con ella, y coleccionar recuerdos juntos.",
