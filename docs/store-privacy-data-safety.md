...
- API/worker provider secrets remain server-side by boundary in `docs/security-boundaries.md`; mobile code does not contain AI provider keys, storage credentials, payment verification secrets, or raw provider responses.
