...
> 배포, 보안 출시 게이트는 `docs/release/backend-release-audit.md`를
> 단일 기준으로 우선한다.
> 관련: `docs/product/economy.md`(BM 확정 가격/파우셋), `docs/product/improvement-backlog.md`(백로그), `docs/engineering/security-boundaries.md`
...
| 법적: 실제 Privacy/Terms/Support 내용 + docs/release/legal (b87ceab) | 변호사 검토 항목 표기 | ✅ 완료 |
