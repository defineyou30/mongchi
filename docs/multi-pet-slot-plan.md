...
### 아직 미결 (W3~W4 진입 전 확정)
1. **이사 상자 등장 조건**: 첫 펫 bond Lv2+ AND 이사 후 7일+ (복합, 추천) / 경과일만 / bond만 / 상시
2. **채팅 무료 티켓**: 유저당 공유(추천) / 펫당 지급
3. **산책 도감**: 가족 공동 도감(공유, 발견자 뱃지만 펫별 — 추천) / 펫별 도감
4. **동거 버프 밸런스 수치** (별도 밸런스 세션)
5. **careStreak 공유 전환** + 친구 페이지 "N days together" 변경 승인 여부
